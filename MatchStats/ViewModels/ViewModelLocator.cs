    ...
    public class ViewModelLocator
    {
        ...
        public MatchStatsViewModel MatchStatsViewModel
        {
            get
            {
                ...
                matchStatsViewModel.Stats.Add(new Stat() {StatName = "Double Faults", ForMatchP1 = "1", ForMatchP2 = "1", ForFirstSetP1 = "0", ForFirstSetP2 = "0", ForSecondSetP1 = "0", ForSecondSetP2 = "1", ForThirdSetP1 = "1", ForThirdSetP2 = "0",IndexWithinParentCollection = 2});
                matchStatsViewModel.Stats.Add(new Stat() { StatName = "Win % for 1st Serve", ForMatchP1 = "76%", ForMatchP2 = "69%", ForFirstSetP1 = "78%", ForFirstSetP2 = "65%", ForSecondSetP1 = "81%", ForSecondSetP2 = "71%", ForThirdSetP1 = "67%", ForThirdSetP2 = "71%",IndexWithinParentCollection = 3});
                matchStatsViewModel.Stats.Add(new Stat() { StatName = "Win % for 2nd Serve", ForMatchP1 = "38%", ForMatchP2 = "41%", ForFirstSetP1 = "27%", ForFirstSetP2 = "50%", ForSecondSetP1 = "55%", ForSecondSetP2 = "36%", ForThirdSetP1 = "33%", ForThirdSetP2 = "25%", IndexWithinParentCollection = 4});
                matchStatsViewModel.Stats.Add(new Stat() { StatName = "Winners", ForMatchP1 = "31", ForMatchP2 = "32", ForFirstSetP1 = "13", ForFirstSetP2 = "10", ForSecondSetP1 = "11", ForSecondSetP2 = "12", ForThirdSetP1 = "7", ForThirdSetP2 = "10", IndexWithinParentCollection = 5});
                matchStatsViewModel.Stats.Add(new Stat() { StatName = "Unforced Errors", ForMatchP1 = "26", ForMatchP2 = "43", ForFirstSetP1 = "13", ForFirstSetP2 = "17", ForSecondSetP1 = "9", ForSecondSetP2 = "16", ForThirdSetP1 = "4", ForThirdSetP2 = "10",IndexWithinParentCollection = 6});
